"""Apply blended-3 style to cinnabar-v3."""
...
INPUT = "new-drafts/cinnabar-v3.png"
...
PROMPT = (
    ...
    "pill-shaped white boxes to make them look hand-painted and blended in."
)
        ...
        for attempt in range(2):
            ...
            try:
                ...
                if img:
                    ...
                    out_path = os.path.join(OUTPUT_DIR, f"cinnabar-v3-blended-{i}.png")
